...
const handleChildFileClick = (event: {
  entry: FileEntry
  path: string
      ...
      <div
        ...
        @dragover="
          (e) =>
            entry.kind === 'directory'
              ...
              : handleFileDragOver(e, entry as FileEntry)
        "
        ...
        @drop="
          (e) =>
            entry.kind === 'directory'
              ? handleDrop(e, entry)
              : handleFileDrop(e, entry as FileEntry)
        "
      >
        ...
        <span v-if="selectionOrder[entry.name]" class="selection-badge">{{
          selectionOrder[entry.name]
        }}</span>
